...
class TestSmokeTest():
  ...
  def test_directoryScreenTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1400, 900)
    WebDriverWait(self.driver, 30000).until(expected_conditions.text_to_be_present_in_element((By.LINK_TEXT, "Directory"), "Directory"))
    self.driver.find_element(By.LINK_TEXT, "Directory").click()
    WebDriverWait(self.driver, 30000).until(expected_conditions.text_to_be_present_in_element((By.ID, "directory-grid"), "GRID"))
  ...
  def test_joinPageInputTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1400, 900)
    self.driver.find_element(By.LINK_TEXT, "Join Us").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".myinput:nth-child(2)").text == "First Name"
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("Flavius")
    self.driver.find_element(By.NAME, "lname").send_keys("Josephus")
    self.driver.find_element(By.NAME, "bizname").send_keys("Falvius Fashions")
